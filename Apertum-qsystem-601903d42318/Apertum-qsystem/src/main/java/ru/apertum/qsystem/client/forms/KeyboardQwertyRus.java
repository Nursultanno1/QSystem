 ...
 */
@SuppressWarnings({"squid:S1612", "squid:S1192", "squid:S1172", "squid:S1450", "squid:S1604", "squid:S1161", "squid:MaximumInheritanceDepth"})
public class KeyboardQwertyRus extends javax.swing.JPanel {
    ...
    private final void setFont(Font font, Color foregraundColor) {
        this.keyFont = font;
    ...
    /**
     * Утилитка посмотреть на клаву.
     */
    public static void main(String[] args) {
        KeyboardQwertyRus keyboardQwertyRus = new KeyboardQwertyRus();
        JFrame f = new JFrame();
        f.setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        f.add(keyboardQwertyRus);
        f.setVisible(true);
        f.setSize(1024, 340);
    }
