...
public class FReception extends javax.swing.JFrame {
                ...
                if (0 == JOptionPane.showConfirmDialog(this, getLocaleMessage("clint.came") + fc + "?", getLocaleMessage("pre.reg.2"), JOptionPane.YES_NO_OPTION)) {
                    ...
                    if (res != null) {
                        ...
                        if (res.getMethod() == null) {// костыль. тут приедет текст запрета если нельзя встать в очередь
                            ...
                            new Thread(() -> FWelcome.printTicket(res.getResult(), ((QService) treeServices.getModel().getRoot()).getTextToLocale(QService.Field.NAME))).start();
                            preRegChange(true);
    ...
    public boolean load() {
        ...
        try {
            ...
            Uses.closeSplash();
            QLog.l().logger().error("Не загрузились стандарты. ", ex); //NOI18N
            return false;
        }
    ...
    public void checkAnyTicket() {
        ...
        if (num != null) {
            ...
            Uses.setLocation(f);
            RpcGetTicketHistory.TicketHistory ticketHistory = NetCommander.checkCustomerNumber(netProperty, num);
