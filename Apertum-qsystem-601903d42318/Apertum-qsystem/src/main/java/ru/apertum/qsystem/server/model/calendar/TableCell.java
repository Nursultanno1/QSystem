...
public class TableCell extends JLabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        if (column == 0) {
            switch (row) {
                case 0:
                    setText(FAdmin.txt("admin.calendar.month.january"));
                    break;
                case 1:
                    setText(FAdmin.txt("admin.calendar.month.february"));
                    break;
                case 2:
                    setText(FAdmin.txt("admin.calendar.month.march"));
                    break;
                case 3:
                    setText(FAdmin.txt("admin.calendar.month.april"));
                    break;
                case 4:
                    setText(FAdmin.txt("admin.calendar.month.may"));
                    break;
                case 5:
                    setText(FAdmin.txt("admin.calendar.month.june"));
                    break;
                case 6:
                    setText(FAdmin.txt("admin.calendar.month.july"));
                    break;
                case 7:
                    setText(FAdmin.txt("admin.calendar.month.augustus"));
                    break;
                case 8:
                    setText(FAdmin.txt("admin.calendar.month.september"));
                    break;
                case 9:
                    setText(FAdmin.txt("admin.calendar.month.october"));
                    break;
                case 10:
                    setText(FAdmin.txt("admin.calendar.month.november"));
                    break;
                case 11:
                    setText(FAdmin.txt("admin.calendar.month.december"));
                    break;
                default:
            ...
            if (checkDate(row, column)) {
                if (isSelected && table.hasFocus()) {
                    setBackground(((CalendarTableModel) table.getModel()).addDay(getDate(row, column),
                        /*!hasFocus*/ !(table.getSelectedColumnCount() == 1 && table.getSelectedRowCount() == 1)) ? Color.lightGray : getWorkColor(row));
                } else {
