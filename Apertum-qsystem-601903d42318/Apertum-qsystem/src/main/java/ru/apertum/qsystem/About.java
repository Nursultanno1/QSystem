...
public class About {
    ...
    public static void main(String[] args) {
        ...
        if (gc.get(Calendar.HOUR_OF_DAY) == 0 || (gc.get(Calendar.MONTH) == 2 && gc.get(Calendar.DAY_OF_MONTH) > 1)) {
            i = 6 * (gc.get(Calendar.SECOND) % 2);
        }
        if (gc.get(Calendar.HOUR_OF_DAY) == 1 || (gc.get(Calendar.MONTH) == 4 && gc.get(Calendar.DAY_OF_MONTH) > 1)) {
            i = (gc.get(Calendar.SECOND) % 2) + 1;
        }
        if (gc.get(Calendar.MONTH) == 10 && gc.get(Calendar.DAY_OF_MONTH) > 1) {
            i = 3;
        }
        if (args.length == 1) {
