...
public interface IFormirovator {
     ...
     * @return null если все хорошо, сообщение обошибке если что-то не в порядке. Это сообщение будет передано в повторный вызов метода getDialog()
     */
