...
public class CodepagePrintStream extends PrintStream {
    ...
    private static final boolean AUTO_FLUSH = false;
     ...
     * which also implement the writebuf() methods of OutputStream
     */
     ...
     * invoked.
     *
     * <p> Note that the byte is written as given; to writebuf a character that</p>
     ...
     *
     * <p> Note that the bytes will be written as given; to writebuf characters</p>
     ...
     * @param len Number of bytes to writebuf
     */
    @Override
     ...
     */
    private void writebuf(char[] buf) {
        try {
            synchronized (this) {
                ensureOpenNew();
                textOut.write(buf);
