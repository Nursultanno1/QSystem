...
public class QServiceTree extends ATreeModel<QService> {
    ...
    @Override
    protected List<QService> load() {
        return new LinkedList<>(Dao.get().findByCriteria(DetachedCriteria.forClass(QService.class)
    ...
    @Override
    public void save() {
        deleted.forEach(t -> QServiceTree.sailToStorm(t, (TreeNode service) -> {
