...
/**
 * Редактор текста в стиле Wysiwyg. Диалоговая форма для показа и редактирования.
 *
...
public class WysiwygDlg extends javax.swing.JDialog {
     ...
     * Паказать редактор.
     *
     * @param data В редактор поместить этот текст.
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(WysiwygDlg.class);
