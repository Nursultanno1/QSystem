...
/**
 * Получить таблицу свободных времен.
 *
...
public class RpcGetGridOfDay extends JsonRPC20 {
    ...
    public static class GridDayAndParams {
        ...
        /**
         * Добавляем время к временам.
         *
         * @param time это время.
         */
    ...
    public static class AdvTime {
        ...
        /**
         * Добавляем предварительного к списку.
         *
         * @param customer этого.
         */
        public void addACustomer(QAdvanceCustomer customer) {
            if (acusts == null) {
